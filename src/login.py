...
class Login:
    ...
    def check_updateInfo(self):
        ...
        if (self.webdriver.title == "Microsoft account | Account Checkup" or
                self.utils.isElementExists(By.ID, 'twoui25')):
            self.utils.closeAddRecovery()
